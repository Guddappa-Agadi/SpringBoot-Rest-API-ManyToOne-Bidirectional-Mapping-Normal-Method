...
public class ProductController {
	...
	@GetMapping("/get/{id}")
	public ResponseEntity<Product> getByIdData(@PathVariable("id") int product_id) {
	...
	@PutMapping("/get/{id}")
	public ResponseEntity<Product> updateByIdData(@PathVariable("id") int product_id, @RequestBody Product c) {
		Optional<Product> lst = cr.findById(product_id);
		if (lst.isPresent()) {
	...
	public ResponseEntity<Product> deleteByIdData(@PathVariable("id") int product_id) {
		Optional<Product> lst = cr.findById(product_id);
		if (lst.isPresent()) {
	...
	@GetMapping("/get/page")
	public List<Product> getAllByPages(@RequestParam int page, @RequestParam int size, @RequestParam String field) {
