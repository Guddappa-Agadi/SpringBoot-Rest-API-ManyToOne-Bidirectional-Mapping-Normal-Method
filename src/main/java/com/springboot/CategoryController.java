...
public class CategoryController {
	...
	@GetMapping("/get/{id}")
	public ResponseEntity<Category> getByIdData(@PathVariable("id") int category_id) {
	...
	@PutMapping("/get/{id}")
	public ResponseEntity<Category> updateByIdData(@PathVariable("id") int category_id, @RequestBody Category c) {
		Optional<Category> lst = cr.findById(category_id);
		if (lst.isPresent()) {
	...
	public ResponseEntity<Category> deleteByIdData(@PathVariable("id") int category_id) {
		Optional<Category> lst = cr.findById(category_id);
		if (lst.isPresent()) {
	...
	@GetMapping("/get/page")
	public List<Category> getAllByPages(@RequestParam int page, @RequestParam int size, @RequestParam String field) {
